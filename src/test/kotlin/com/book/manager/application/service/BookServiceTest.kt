...
internal class BookServiceTest {
    private val bookRepository = mock<BookRepository>() // mockでモック化したオブジェクトを生成
    ...
    fun `getList when book list is exist then return list`() {
        ...
        whenever(bookRepository.findAllWithRental()).thenReturn(expected) // モックオブジェクトが処理する関数と戻り値を設定
